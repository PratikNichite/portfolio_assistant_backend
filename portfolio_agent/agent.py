...
class PortfolioAssistant:
    ...
    def system_prompt(self):
        return (
            ...
            f"Whenever asked about projects, answer with 5 projects, title of each project and one summerized very short version of description of no more than one sentence and"
