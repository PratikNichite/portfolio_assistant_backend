...
class PortfolioAssistant:
    ...
    def system_prompt(self):
        return (
            ...
            f"Whenever you encounter content that has a reference link, include the link in your response."
            f"If the link is to be mentioned while answering qustion related to overall projects, then use click here text for link."
